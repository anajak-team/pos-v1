                            ...
                            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 rounded-[2rem] min-w-[320px] shadow-2xl space-y-4">
                                ...
                                <div className="space-y-2 text-sm pt-4 border-t border-white/10">
                                    ...
                                    <div className="flex justify-between pt-2 mt-2 border-t border-white/10">
                                        ...
                                        <span className="font-extrabold text-white">{(purchasePoints).toLocaleString()} pts</span>
                                    </div>
                                </div>
                            </div>
...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onViewDemo, settings, products = [], currentUser, customerData, transactions = [], repairs = [], onLogout }) => {
  ...
  return (
    <div className="h-screen w-full overflow-y-auto overflow-x-hidden flex flex-col font-sans text-slate-900 dark:text-white scroll-smooth relative bg-transparent">
